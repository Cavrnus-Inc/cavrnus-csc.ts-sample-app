...
// 	public setLocalUserMutedState(spaceConnection: CavrnusSpaceConnection, connectionId: string, value: boolean): void
// 	{
// 		try
// 		{
// 			if (!this.cavrnusFunctionLibrary)
...
// 			this.cavrnusFunctionLibrary.setLocalUserMutedState(spaceConnection, connectionId, value);
// 		}
// 		catch (err)
// 		{
// 			console.error(err);
...
// 	public requestRemoteUserMuted(spaceConnection: CavrnusSpaceConnection, container: string): void
// 	{
// 		try
// 		{
// 			if (!this.cavrnusFunctionLibrary)
...
// 			this.cavrnusFunctionLibrary.requestRemoteUserMute(spaceConnection, container);
// 		}
// 		catch (err)
// 		{
// 			console.error(err);
